...
void product4(double *A, mwIndex *irA, mwIndex *jcA, 
              ...
              double *Ptmp, mwSize numblk, mwIndex *cumblk)
...
void product5(double *A, mwIndex *irA, mwIndex *jcA, 
              ...
              mwSize n, mwSize isspA, mwSize isspB)
	         ...
	         int nrhs,  const mxArray  *prhs[] )
{
   ...
   mwIndex  *cumblk;
   mwSize    isspA, isspB, m1, n1, m2, n2;
   mwSize    type, index, numblk, NZmax, cols, i, l;
   mwIndex   subs[2];
   mwSize    nsubs=2;
...
/*** get pointers ***/  
    ...
    if (nrhs > 3) { type = (mwSize)mxGetScalar(prhs[3]); }
    else          { type = 0; }
    subs[0] = 0;  subs[1] = 1;
    ...
    cumblk = mxCalloc(numblk+1,sizeof(mwIndex)); 
    NZmax = 0; 
    for (l=0; l<numblk; l++) { 
